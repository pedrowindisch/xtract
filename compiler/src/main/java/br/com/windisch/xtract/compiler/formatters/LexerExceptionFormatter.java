...
public class LexerExceptionFormatter extends XtractExceptionFormatter {
    public LexerExceptionFormatter(String sourceCode, XtractCompilerException exception) {
